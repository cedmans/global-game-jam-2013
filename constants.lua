...
Constants.MOUTH_HEALTH_EFFECT = 20
Constants.MOUTH_HEALTH_DURATION = 3
Constants.MOUTH_COOLDOWN = 2

Constants.WAVE_EFFECTIVE_DISTANCE = 350
Constants.WAVE_ANGLE_OF_OCCURRENCE = 3
Constants.WAVE_HEALTH_EFFECT = 20
Constants.WAVE_HEALTH_DURATION = 0.5
Constants.WAVE_COOLDOWN = 1

Constants.HIGH_FIVE_EFFECTIVE_RADIUS = 50
...
Constants.LOVE_POTION_COOLDOWN = 10
Constants.LOVE_POTION_HEALTH_EFFECT = 100
Constants.LOVE_POTION_HEALTH_DURATION = 3
